...
export class CompanyPlatformController {
  constructor(private readonly companyPlatformService: CompanyPlatformService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCompanyPlatformDto: UpdateCompanyPlatformDto) {
